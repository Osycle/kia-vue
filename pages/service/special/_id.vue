    ...
    <div class="bnr-style-1 color-white bg-shadow-none" :style="'background-image: url(https://cdn.kia.ru/'+page.offer.detail_image+');'">
      <div class="breadcrumb-container">
        <div class="container-p">
          <ol class="breadcrumb">
            ...
            <li><nuxt-link to="/service/special/">Спецпредложение</nuxt-link></li>
      ...
      <div class="container-p relative">
        <div class="entry-header">
          <h1 class="box-md-5">{{page.offer.name}}</h1>
          <p class="box-md-4">{{page.offer.preview_text}}</p>
        </div>
      </div>
    </div>
    <div class="special-info">
      <div class="container-p">
        <div class="wrapper p-v-md-50 flex-adaptive p-h-md-110 list-check justify-c-center">
          <div class="box-md-5 m-v-30 p-h-15 text-item">
            <div v-html="page.offer.detail_text"></div>
          </div>
        </div>
      </div>
    </div>
