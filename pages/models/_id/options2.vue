		...
		<div class="options-entry scrolled-down">
			<div class="container-p relative">
						...
						<div class="config-filter-items">
							<fieldset>
								...
								<div class="input-items">
									<label role="button" class="align-center m-v-15" 
										...
										:key="key">
										<input type="checkbox" name="" class="none" :value="engine.id">
										<span class="checkbox-style-1"></span>
							...
							<fieldset>
								...
								<div class="input-items">
									<label role="button" class="align-center m-v-15" 
										...
										:key="key">
										<input type="checkbox" name="" class="none" :value="complectation.id">
										<span class="checkbox-style-1"></span>
							...
							<fieldset>
								...
								<div class="collapse-content">
									<fieldset v-for="(option, key) in page_data.options" :key="key">
										<a data-toggle="collapse" data-parent="#accordion" href="#prc-1" aria-expanded="true">
											<span>{{key}}</span><i class="fa fa-angle-down"></i>
										</a>
				...
				<div class="config-details">
					...
					<section class="item" v-for="(items, key) in page_data.options" :key="key">
						<a href=".item" class="title-click" tc tc-closest>{{key}}<i class="fa fa-angle-up"></i></a>
						<div class="section-body">
							<div class="section-body-wrapper">
								<div class="config-param-item" v-for="(option, childrenKey) in items" :key="childrenKey">
